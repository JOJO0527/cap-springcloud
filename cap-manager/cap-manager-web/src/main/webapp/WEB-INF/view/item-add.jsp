...
<div style="padding:10px 10px 10px 10px">
    <form id="itemAddForm" class="itemForm" method="post">
        <table cellpadding="5">
           ...
           <%-- <tr>
                <td>商品起始拍卖价格:</td>
                <td><input class="easyui-numberbox" type="text" name="openingbidView"
                           data-options="min:1,max:99999999,precision:2,required:true"/>
...
<%--            <tr>--%>
<%--                <td>商品拍卖截止日期:</td>--%>
<%--                <td><input class="easyui-datebox" name="countdown" data-options="required:true,showSeconds:false"--%>
<%--                           style="width:150px"/>--%>
<%--                    &lt;%&ndash;<input type="hidden" name="countdown"/></td>&ndash;%&gt;--%>
<%--            </tr>--%>
            <tr>
                <td>库存数量:</td>
