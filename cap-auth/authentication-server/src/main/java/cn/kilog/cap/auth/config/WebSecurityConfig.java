...
//        PhoneAuthenticationProvider cn.kilog.cap.auth.provider = new PhoneAuthenticationProvider();
//        // 设置userDetailsService
//        cn.kilog.cap.auth.provider.setUserDetailsService(phoneUserDetailService);
//        // 禁止隐藏用户未找到异常
//        cn.kilog.cap.auth.provider.setHideUserNotFoundExceptions(false);
//        return cn.kilog.cap.auth.provider;
//    }
//
//    @Bean
//    public QrAuthenticationProvider qrAuthenticationProvider(){
//        QrAuthenticationProvider cn.kilog.cap.auth.provider = new QrAuthenticationProvider();
//        // 设置userDetailsService
//        cn.kilog.cap.auth.provider.setUserDetailsService(qrUserDetailService);
//        // 禁止隐藏用户未找到异常
//        cn.kilog.cap.auth.provider.setHideUserNotFoundExceptions(false);
//        return cn.kilog.cap.auth.provider;
//    }
