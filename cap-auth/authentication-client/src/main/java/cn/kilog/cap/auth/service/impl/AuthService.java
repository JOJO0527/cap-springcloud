...
import cn.kilog.cap.auth.provider.AuthProvider;
import cn.kilog.cap.auth.service.IAuthService;
...
public class AuthService implements IAuthService {
    ...
    @Override
    public ResponseResult authenticate(String authentication, String url, String method) {
    ...
    @Override
    public boolean hasPermission(ResponseResult authResult) {
        log.debug("签权结果:{}", authResult.getData());
        return authResult != null && authResult.getStatus() == 200 && (boolean) authResult.getData();
    }
